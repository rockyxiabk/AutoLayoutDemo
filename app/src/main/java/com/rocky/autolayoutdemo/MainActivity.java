...
import com.rocky.autolayoutdemo.fragment.ListFragment;
import com.rocky.autolayoutdemo.fragment.PayFragment;
import com.rocky.autolayoutdemo.fragment.RecyclerViewFragment;
import com.rocky.autolayoutdemo.fragment.RecyclerViewGridFragment;
import com.rocky.autolayoutdemo.fragment.RegisterFragment;
import com.rocky.autolayoutdemo.fragment.TestFragment;
...
public class MainActivity extends AutoLayoutActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setImmersionStatus();
        setContentView(com.zhy.sample.R.layout.activity_main);
        initView();
        initDatas();
    }
...
//			getWindow().addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.zhy.sample.R.menu.menu_main, menu);
        return true;
    }
